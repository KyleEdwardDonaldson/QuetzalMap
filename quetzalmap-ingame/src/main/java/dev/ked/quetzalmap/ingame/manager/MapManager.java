...
public class MapManager {
    ...
    public MapView getOrCreateMapView(Player player) {
        ...
        // Remove default renderer - it only shows visited chunks
        // We'll render the terrain ourselves to show all chunks
        for (MapRenderer defaultRenderer : mapView.getRenderers()) {
            mapView.removeRenderer(defaultRenderer);
        }

        // Add our custom renderer that handles both terrain and overlays
